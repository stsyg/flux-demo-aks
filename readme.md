...
>Note: this file was cloned from https://github.com/gbaeke/quick-guides/blob/main/fluxv2/README.md and used to create a demo on my AKS cluster.
...
# Le'ts pretend that we need Redis for our app
